...
public final class UserLookup {
    ...
    public static Map<UUID, UserSummaryDto> usersById(UserClient userClient, Collection<UUID> userIds) {
        ...
        try {
            return userClient.getUsersByIds(ids).stream()
                    ...
                    .collect(Collectors.toMap(UserSummaryDto::getId, Function.identity(), (first, second) -> first));
        } catch (Exception e) {
